...
include::../requirements/data-model/REQ_standard_name_binding_declaration.adoc[]
include::../recommendations/data-model/REC_standard_name_binding_declaration.adoc[]
include::../recommendations/data-model/PER_standard_name_binding_declaration.adoc[]

NOTE: If the CF Conventions community publishes an official vocabulary server endpoint in the future, that URI should be used in preference to the NERC mirror. Hubs should be prepared to recognise URIs from recognised CF standard name vocabulary server mirrors as equivalent for the purposes of name resolution.
...
include::../requirements/data-model/REQ_standard_name_binding_assignment.adoc[]
include::../recommendations/data-model/PER_standard_name_binding_assignment.adoc[]
...
include::../requirements/data-model/REQ_standard_name_binding_hierarchy.adoc[]
include::../recommendations/data-model/REC_standard_name_binding_hierarchy.adoc[]
include::../recommendations/data-model/PER_standard_name_binding_hierarchy.adoc[]
...
IMPORTANT: Where a standard name exists at Level 1 or Level 2, that standard name is be included in the Parameter message ``standardNames`` element. Any locally managed entries for the same parameter are supplementary to, not a replacement for, the applicable standard name.
