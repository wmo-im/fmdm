...
Standard name binding follows a three-level hierarchy of vocabularies, described in xref:standard-name-hierarchy[]. The use of standard names is optional but recommended where machine-to-machine interoperability is required. A Node may bind a single parameter to standard names from multiple vocabularies simultaneously.
